...
<?php foreach ($kamar as $roweditkamar) {
    $nama=$roweditkamar->nama;
    $biaya=$roweditkamar->biaya;
    $id=$roweditkamar->id_kamar;
...
<center><b>Edit Data </b></center>
          <form action="<?php echo base_url()?>index.php/admin/kamar/update" method="POST">
