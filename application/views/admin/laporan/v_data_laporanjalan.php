...
<div class="container my-5">
    ...
    <form action="<?php echo base_url()?>index.php/admin/laporanjalan/cetak" method="post">
            ...
            ?> 
                <tr> 
                   <td><?php echo $no ?></td>
                    ...
                    <td>
                    <a class="btn btn-sm btn-danger" href="<?php echo base_url() ?>index.php/admin/laporanjalan/hapus/<?php echo $rowtransaksi->id_transaksi ?>"><i class="fa fa-trash"></i> Delete</a>    
                    <td><a class="btn btn-sm btn-info" href="<?php echo base_url() ?>index.php/admin/laporanjalan/detail/<?php echo $rowtransaksi->reg ?>"><i class="fa fa-info-circle"></i> Details</a> </td>
                    </td>
                </tr>
                <?php }} ?>
            </tbody>
