...
<div class="card-body text-center">
            <h4 class="card-title">Tambah Data Transaksi Pasien NON OBYGN</h4>
            <!--<p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
          </div>-->
            <div class=" card col-8 offset-2 my-2 p-3">
<form action="<?php echo base_url()?>index.php/admin/transaksiinap1/cetak" method="POST">
<div class="row">
    <div class="col-sm-2">
    ...
    <div class="col-sm">
    <input type="text" name="infus" class="form-control"/>
    </div>
    </div><br>
