...
<div class="card-body text-center">
            ...
            <h4 class="card-title">Tambah Data Transaksi Pasien</h4>
            <!--<p class="card-text">With supporting text below as a natural lead-in to additional content.</p>
          </div>-->
            <div class=" card col-8 offset-2 my-2 p-3">
<form action="<?php echo base_url()?>index.php/admin/transaksijalan/cetak" method="POST">
<div class="row">
    <div class="col-sm-2">
    ...
    <select class="form-control" name="jalan">
                ...
                <option value="<?php echo $rowjalan->id_rawat_jalan?>"><?php echo $rowjalan->nama?></option>
                <?php } ?>
            </select>
    </div>
    </div><br>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#reg').change(function(){
			var reg=$(this).val();
			$.ajax({
				url : "<?php echo base_url();?>index.php/admin/transaksijalan/tes5",
				method : "POST",
				data : {reg: reg},
				async : false,
		        dataType : 'json',
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#jumlah_obat').change(function(){
			...
			$.ajax({
				url : "<?php echo base_url();?>index.php/admin/transaksijalan/tes2",
				method : "POST",
				async : false,
		        dataType : 'json',
				success: function(data){
